...
def run_ml_app():
    ...
    loan_amount_term = left.number_input('Loan Amount Term in days')
...
def predict(gender, married, dependent, education, self_employed, applicant_income, coApplicant_income
    ...
    prediction = Logistic_Regression_Model.predict(np.reshape([gen, mar, dep, edu, sem, applicant_income, cap, lam, loan_amount_term, credit_history, pro], (-1, 11)))
